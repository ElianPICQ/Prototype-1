...
//Icones de mini-jeux ciblées
const shifumiToggle = document.getElementById('shifumi-icone');
const swordToggle = document.getElementById('infinite-sword-icone');
const uselessButtonToggle = document.getElementById('useless-button-icone');
...
function  changeH(value) {
  let hsl = window.getComputedStyle(hslCanvas).backgroundColor;
  console.log("hsl = ", hsl);

  let colorArr = hsl.match(/\d+/g).map(Number);
  console.log(colorArr);
}
*/

/* Bouton toggle RGB/HSL */
/*
rgbButton.addEventListener("click", function() {
  if (rgbCanvas.classList.contains("hide-canvas")) {
    hslCanvas.classList.replace("show-canvas", "hide-canvas");
    rgbCanvas.classList.replace("hide-canvas", "show-canvas");
  }
});

hslButton.addEventListener("click", function() {
  if (hslCanvas.classList.contains("hide-canvas")) {
    rgbCanvas.classList.replace("show-canvas", "hide-canvas");
    hslCanvas.classList.replace("hide-canvas", "show-canvas");
  }
});
*/
  /*************************/
 /* JAVASCRIPT POUR SKILLS*/
/*************************/

const skills_button = document.getElementById("skills__toggle");
